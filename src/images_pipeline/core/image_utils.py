...
try:
    ...
    # Type stubs for when PIL is not available
    Image = Any
    TAGS = {}


def native_kmeans_quantize(img: Image.Image, k: int = 8, max_iter: int = 10) -> Image.Image:
    """
...
def sklearn_kmeans_quantize(img: Image.Image, k: int = 8) -> Image.Image:
    ...
    try:
        ...
        raise ImportError("numpy and scikit-learn are required for sklearn_kmeans_quantize")
